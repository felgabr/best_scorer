...
from supplementary import DateAux, LakeAux, MergerDF, ReportManager
...
# Output
report = __CONFIG__['rep_auditnum']
...
try:
    ...
    for date in dates:
        ...
        dfs_list.append(Auditor.audit_varnum(df_tmp, date[0], not_eval=list(config['spine'].values()))
